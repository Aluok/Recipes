 ...
 * @ORM\Entity(repositoryClass="RecipeBundle\Repository\CommentRepository")
 */
class Comment
{
    /**
     ...
     * Add response
     *
     * @param \RecipeBundle\Entity\Comment $response
     *
     * @return Comment
     */
    public function addResponse(\RecipeBundle\Entity\Comment $response)
    {
     ...
     * @param \RecipeBundle\Entity\Comment $response
     */
    public function removeResponse(\RecipeBundle\Entity\Comment $response)
    {
